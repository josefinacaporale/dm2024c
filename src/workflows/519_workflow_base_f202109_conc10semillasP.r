...
#modificacomos desde aca
  param_local$train$training <- c(202103, 202102, 202101,202012, 202011, 202010,202009,202002,202001)
...
wf_septiembre <- function( pnombrewf )
{
  ...
  fm <- FM_final_models_lightgbm( c(ht, ts9), ranks=c(1), qsemillas=10 ) #mientra mas semillas mejor
  SC_scoring( c(fm, ts9) )
  KA_evaluate_kaggle()
